...
class State {
    ...
    serialize({ value } = { value: true }) {
        return Object.assign(Object.assign({ ref: this.ref, status: this.status }, (value ? { value: this.value } : {})), (this.name ? { name: this.name } : {}));
    }
    /**
    ...
    static deserialize(state) {
        return new State(Object.assign({}, state));
    }
    /**

import { Activity, Sequence, TakeOutgoingInterface } from '../base';
...
export declare class GatewayActivity extends Activity {
    ...
    protected takeGatewayOutgoing(identity?: IdentityOptions): Activity[] | undefined;
    /**
    ...
    takeOutgoings(options: TakeOutgoingInterface[]): void;
    /**

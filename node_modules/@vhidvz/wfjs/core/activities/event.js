...
})(IntermediateType || (exports.IntermediateType = IntermediateType = {}));
...
})(EventDefinitionType || (exports.EventDefinitionType = EventDefinitionType = {}));
...
class EventActivity extends base_1.Activity {
    ...
    get attachedToRef() {
        if (!this.$.attachedToRef)
            return;
        const data = (0, tools_1.getWrappedBPMNElement)(this.process, { id: this.$.attachedToRef });
        if (data)
            return (0, tools_1.getActivity)(this.process, data);
    }
    /**

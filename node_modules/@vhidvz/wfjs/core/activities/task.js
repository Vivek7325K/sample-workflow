...
class TaskActivity extends base_1.Activity {
    ...
    get attachments() {
        var _a;
        const boundaries = ((_a = this.process['bpmn:boundaryEvent']) !== null && _a !== void 0 ? _a : [])
            .filter((e) => e.$.attachedToRef === this.$.id)
            .map((e) => (0, tools_1.getWrappedBPMNElement)(this.process, e.$));
        return boundaries.filter((e) => !!e).map((e) => (0, tools_1.getActivity)(this.process, e));
    }
    /**
     * If the key property of the current object contains the word "send", return the value of the Send
